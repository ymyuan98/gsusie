#' @title Check abnormal points
#' 
#' @description Function \code{check_abnormal_subjects()} checks abnormal 
#' data points (subjects) in iterative weighted least square regressions. 
#' 
